...
class SegModel(nn.Module):
    ...
    def load_pretrained_weights(self, state_dict_encoder, state_dict_decoder):
        ...
        print(self.encoder.load_state_dict(state_dict_encoder, strict=True))
        print(self.decoder.load_state_dict(state_dict_decoder, strict=True))
...
model_path = "/home/viktor/Documents/kaggle/vesuvius-challenge/experiments/ensembling/3D-models/bce-dice/fold-1/depth-34/image-512-weighted-loss-v2-cont/ckpts/resnet34_3d_seg_epoch_54.pt"
        
model_path = "model-init.pt"
...
# model.load_pretrained_weights(state_dict_encoder, state_dict_decoder)
...
for epoch in range(1, EPOCHS+1):
    ...
    # torch.save(model.encoder.state_dict(), f"./ckpts/resnet34_3d_seg_encoder_epoch_{epoch}.pt")
    # torch.save(model.decoder.state_dict(), f"./ckpts/resnet34_3d_seg_decoder_epoch_{epoch}.pt")
    ...
    for threshold in np.arange(0.1, 1.00, 0.02):
        ...
        if fbeta_best < fbeta:
            fbeta_best = fbeta
            out[f"fbeta_best"] = fbeta_best.item()
