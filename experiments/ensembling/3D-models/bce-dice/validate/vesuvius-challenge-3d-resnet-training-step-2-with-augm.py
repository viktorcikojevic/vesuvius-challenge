...
model_path = "/home/viktor/Documents/kaggle/vesuvius-challenge/experiments/ensembling/3D-models/bce-dice/fold-1/depth-18/image-256/ckpts/resnet34_3d_seg_best_0.900.pt"
...
print(np.mean(final_pred_mask.cpu().numpy()), np.mean(gt_mask.cpu().numpy()))
