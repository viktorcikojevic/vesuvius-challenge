...
class VesuviusTrain(Dataset):
    ...
    def __getitem__(self, i):
        ...
        frag_crop = FRAGMENTS_ZARR[fragment].surface_volume[y1:y2, x1:x2, 16+z_offset:40+z_offset]
...
class VesuviusVal(Dataset):
    ...
    def __getitem__(self, i):
        ...
        frag_crop = self.fragment.surface_volume[y1:y2, x1:x2, 16+z_offset:40+z_offset]
...
for epoch in range(1, EPOCHS+1):
    ...
    for threshold in np.arange(0.2, 1.00, 0.05):
        ...
        if fbeta_best < fbeta:
            fbeta_best = fbeta
            torch.save(model.state_dict(), f"./ckpts/resnet34_3d_seg_best_{fbeta_best:.4f}.pt")
